...
from .zoo import OPERATIONS, ShowUIModel
...
def load_model(model_name, model_path, **kwargs):
    ...
    logger.info(f"Loading ShowUI-2B model from {model_path}")

    # Create and return the model - operations specified at apply time
    return ShowUIModel(model_path=model_path, **kwargs)
...
def resolve_input(model_name, ctx):
    ...
    inputs.enum(
        ...
        required=True,
        label="Operation",
        description="Type of task to perform with ShowUI-2B model",
